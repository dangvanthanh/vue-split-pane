(function (global, factory) {
  ...
  __vue_render__._withStripped = true;
    ...
    const __vue_inject_styles__ = function (inject) {
      if (!inject) return
      inject("data-v-3a799002_0", { source: "\n.split-pane[data-v-3a799002] {\n  display: flex;\n  flex-direction: row;\n  height: 80%;\n}\n.split-pane-item[data-v-3a799002],\n.split-pane-gutter[data-v-3a799002] {\n  height: 80%;\n}\n.split-pane-gutter[data-v-3a799002] {\n  background: #000;\n  opacity: 0.2;\n  z-index: 1;\n  box-sizing: border-box;\n  background-clip: padding-box;\n  width: 11px;\n  margin: 0 -5px;\n  border-left: 5px solid rgba(255, 255, 255, 0);\n  border-right: 5px solid rgba(255, 255, 255, 0);\n  cursor: col-resize;\n}\n.split-pane-gutter[data-v-3a799002]:hover,\n.split-pane-gutter[data-v-3a799002]:focus {\n  border-left: 5px solid rgba(0, 0, 0, 0.5);\n  border-right: 5px solid rgba(0, 0, 0, 0.5);\n  transition: all 2s ease;\n}\n.is-dragging[data-v-3a799002] {\n  cursor: col-resize;\n}\n", map: {"version":3,"sources":["/Users/dangvanthanh/Code/Vue/vue-split-pane/src/VueSplitPane.vue"],"names":[],"mappings":";AAyDA;EACA,aAAA;EACA,mBAAA;EACA,WAAA;AACA;AAEA;;EAEA,WAAA;AACA;AAEA;EACA,gBAAA;EACA,YAAA;EACA,UAAA;EACA,sBAAA;EACA,4BAAA;EACA,WAAA;EACA,cAAA;EACA,6CAAA;EACA,8CAAA;EACA,kBAAA;AACA;AAEA;;EAEA,yCAAA;EACA,0CAAA;EACA,uBAAA;AACA;AAEA;EACA,kBAAA;AACA","file":"VueSplitPane.vue","sourcesContent":["<template>\n  <div\n    class=\"split-pane\"\n    :class=\"{ 'is-dragging': dragging }\"\n    @mousemove=\"dragMove\"\n    @mouseup=\"dragEnd\"\n    @mouseleave=\"dragEnd\"\n  >\n    <div class=\"split-pane-item\" :style=\"{ width: splitLeft }\">\n      <slot name=\"left\" />\n    </div>\n    <div class=\"split-pane-gutter\" @mousedown=\"dragStart\"></div>\n    <div class=\"split-pane-item\" :style=\"{ width: splitRight }\">\n      <slot name=\"right\" />\n    </div>\n  </div>\n</template>\n\n<script>\nexport default {\n  name: 'VueSplitPane',\n  data() {\n    return {\n      gutter: 11,\n      split: 50,\n      dragging: false,\n    };\n  },\n  computed: {\n    splitLeft: function () {\n      return `calc(${this.split}% - ${this.gutter}px)`;\n    },\n    splitRight: function () {\n      return `calc(${100 - this.split}% - ${this.gutter}px)`;\n    },\n  },\n  methods: {\n    dragStart(e) {\n      this.dragging = true;\n      this.startX = e.pageX;\n      this.startSplit = this.split;\n    },\n    dragMove(e) {\n      if (this.dragging) {\n        const dx = e.pageX - this.startX;\n        const totalWidth = this.$el.offsetWidth;\n        this.split = this.startSplit + ~~((dx / totalWidth) * 100);\n      }\n    },\n    dragEnd() {\n      this.dragging = false;\n    },\n  },\n};\n</script>\n\n<style scoped>\n.split-pane {\n  display: flex;\n  flex-direction: row;\n  height: 80%;\n}\n\n.split-pane-item,\n.split-pane-gutter {\n  height: 80%;\n}\n\n.split-pane-gutter {\n  background: #000;\n  opacity: 0.2;\n  z-index: 1;\n  box-sizing: border-box;\n  background-clip: padding-box;\n  width: 11px;\n  margin: 0 -5px;\n  border-left: 5px solid rgba(255, 255, 255, 0);\n  border-right: 5px solid rgba(255, 255, 255, 0);\n  cursor: col-resize;\n}\n\n.split-pane-gutter:hover,\n.split-pane-gutter:focus {\n  border-left: 5px solid rgba(0, 0, 0, 0.5);\n  border-right: 5px solid rgba(0, 0, 0, 0.5);\n  transition: all 2s ease;\n}\n\n.is-dragging {\n  cursor: col-resize;\n}\n</style>\n"]}, media: undefined });
